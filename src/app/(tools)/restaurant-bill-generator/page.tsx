  ...
  return (
    <div className="space-y-8">
      ...
      <article className="prose prose-blue max-w-none bg-white p-8 rounded-xl border border-gray-200">
        <h2>Restaurant Bill Generator for Reimbursement</h2>
        <p>Easily create professional food bills and restaurant invoices. This tool includes automatic GST calculation (CGST & SGST) and supports dynamic item additions.</p>
        <ul>
            <li>**Accurate Tax Logic:** Automatically splits 5% GST into 2.5% CGST and SGST.</li>
            <li>**Service Charge:** Optional field to add restaurant service charges.</li>
            <li>**POS Style:** Mimics standard thermal receipts used by Indian restaurants.</li>
        </ul>
      </article>
    </div>
  );
